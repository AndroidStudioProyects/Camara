 ...
 */
public class ConnectUploadAsyncService extends AsyncTask<Void,Integer,Boolean> {
    ...
    public ConnectUploadAsyncService(Context contexto, String ip, String userName, String pass){
